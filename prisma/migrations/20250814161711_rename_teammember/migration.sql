/*
  ...
  - You are about to drop the column `firstName` on the `TeamMember` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "public"."TeamMember" DROP COLUMN "firstName",
